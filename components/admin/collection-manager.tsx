  ...
  return (
    <div className="space-y-4">
      <div className="glass p-4 grid grid-cols-12 gap-2 items-end">
        <input placeholder={t('slug')} className="input col-span-3" value={creating.slug} onChange={(e) => setCreating({ ...creating, slug: e.target.value })} />
        <input placeholder={t('nameEn')} className="input col-span-4" value={creating.nameEn} onChange={(e) => setCreating({ ...creating, nameEn: e.target.value })} />
        <input placeholder={t('nameAr')} className="input col-span-4" value={creating.nameAr} onChange={(e) => setCreating({ ...creating, nameAr: e.target.value })} />
